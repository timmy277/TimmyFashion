            ...
            <div className='container'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
                    ...
                    <div className="flex flex-col justify-center gap-6 sm:pt-0">
                        <h1 data-aos="fade-up" className='text-3xl sm:text-4xl font-bold'>Winter Sale Up to 70% Off</h1>
                        <p data-aos="fade-up" className='text-sm text-gray-200 tracking-wide leading-5'>Lorem ipsum dolor sit amet</p>
